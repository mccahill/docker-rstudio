...
RUN DEBIAN_FRONTEND=noninteractive wget \
   ...
   http://archive.linux.duke.edu/cran/src/contrib/Rcpp_0.12.19.tar.gz \
   ...
   http://archive.linux.duke.edu/cran/src/contrib/stringi_1.1.3.tar.gz \
...
RUN DEBIAN_FRONTEND=noninteractive wget \
   ...
   http://archive.linux.duke.edu/cran/src/contrib/psych_1.6.12.tar.gz \
