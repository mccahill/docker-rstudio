...
RUN DEBIAN_FRONTEND=noninteractive gdebi rstudio-server-1.1.383-amd64.deb
...
RUN DEBIAN_FRONTEND=noninteractive wget \
   ...
   https://mirrors.nics.utk.edu/cran/src/contrib/rlang_0.1.4.tar.gz \
...
RUN DEBIAN_FRONTEND=noninteractive wget \
   ...
   https://mirrors.nics.utk.edu/cran/src/contrib/tidyr_0.7.0.tar.gz \
   ...
   https://mirrors.nics.utk.edu/cran/src/contrib/tidyselect_0.1.1.tar.gz \
...
RUN DEBIAN_FRONTEND=noninteractive wget \
   https://mirrors.nics.utk.edu/cran/src/contrib/rgdal_1.2-10.tar.gz \
