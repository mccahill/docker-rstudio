...
RUN DEBIAN_FRONTEND=noninteractive wget \
    ...
    https://mirrors.nics.utk.edu/cran/src/contrib/sconnect_0.8.8.tar.gz \
...
RUN DEBIAN_FRONTEND=noninteractive wget \
    ...
    https://mirrors.nics.utk.edu/cran/src/contrib/abynames_0.3.0.tar.gz \
